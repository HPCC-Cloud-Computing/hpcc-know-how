...
chú ý: vlan triển khai eth2 nên eth2 phải manual và không assign ip
...
neutron subnet-create --name ext-subnet-vlan1 --dns-nameserver 8.8.4.4 --gateway 192.168.8.1 provider-vlan1 192.168.8.0/24
