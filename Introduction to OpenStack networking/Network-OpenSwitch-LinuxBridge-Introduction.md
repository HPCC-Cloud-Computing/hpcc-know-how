#Giới thiệu về các loại mạng layer2 trong OpenStack,  công nghệ ảo hóa layer2 với linux-bridge và openVSwitch;   và cách triển khai các loại mạng trên bằng linux-bridge và openvSwitch
